...
class LandingPageController extends Controller
{
    ...
    public function dbInsertAbout(Request $request){
        ...
        try {
            ...
            //save image
            Image::make($request->file('image1'))->fit(628, 619)->save('landingpage_asset/images/about/' . $image1)->destroy();
            Image::make($request->file('image2'))->fit(628, 619)->save('landingpage_asset/images/about/' . $image2)->destroy();
            Image::make($request->file('image3'))->fit(628, 619)->save('landingpage_asset/images/about/' . $image3)->destroy();
            Image::make($request->file('image4'))->fit(628, 619)->save('landingpage_asset/images/about/' . $image4)->destroy();

            //save thumbnail image
            Image::make($request->file('image1'))->fit(239, 256)->save('landingpage_asset/images/about/thumbnail/' . $imageThumb1)->destroy();
            Image::make($request->file('image2'))->fit(239, 256)->save('landingpage_asset/images/about/thumbnail/' . $imageThumb2)->destroy();
            Image::make($request->file('image3'))->fit(239, 256)->save('landingpage_asset/images/about/thumbnail/' . $imageThumb3)->destroy();
            Image::make($request->file('image4'))->fit(239, 256)->save('landingpage_asset/images/about/thumbnail/' . $imageThumb4)->destroy();
